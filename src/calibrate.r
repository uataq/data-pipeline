...
#' @import dplyr
#' @export
calibrate <- function(time, meas, known, auto = F, er_tol = 0.1, dt_tol = 18000) {
  ...
  data$meas[data$per_dtmax > dt_tol] <- NA
